...
typedef SPRITE_HANDLE						(*pfnEngSrc_pfnSPR_Load_t )			( const char *szPicName );
typedef int							(*pfnEngSrc_pfnSPR_Frames_t )			( SPRITE_HANDLE hPic );
typedef int							(*pfnEngSrc_pfnSPR_Height_t )			( SPRITE_HANDLE hPic, int frame );
typedef int							(*pfnEngSrc_pfnSPR_Width_t )			( SPRITE_HANDLE hPic, int frame );
typedef void						(*pfnEngSrc_pfnSPR_Set_t )				( SPRITE_HANDLE hPic, int r, int g, int b );
...
typedef void						(*pfnEngSrc_pfnSetCrosshair_t )		( SPRITE_HANDLE hspr, wrect_t rc, int r, int g, int b );
...
typedef const struct model_s *		(*pfnEngSrc_GetSpritePointer_t )		( SPRITE_HANDLE hSprite );
...
typedef void	(*pfnEngDst_pfnSPR_Frames_t )			( SPRITE_HANDLE * );
typedef void	(*pfnEngDst_pfnSPR_Height_t )			( SPRITE_HANDLE *, int * );
typedef void	(*pfnEngDst_pfnSPR_Width_t )			( SPRITE_HANDLE *, int * );
typedef void	(*pfnEngDst_pfnSPR_Set_t )				( SPRITE_HANDLE *, int *, int *, int * );
...
typedef void	(*pfnEngDst_pfnSetCrosshair_t )			( SPRITE_HANDLE *, struct rect_s *, int *, int *, int * );
...
typedef void	(*pfnEngDst_GetSpritePointer_t )		( SPRITE_HANDLE * );

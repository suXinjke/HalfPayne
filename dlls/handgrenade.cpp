...
void CHandGrenade::WeaponIdle( void )
{
	...
	if ( m_flStartThrow )
	{
		...
		Vector angThrow = forwardDeg + m_pPlayer->pev->punchangle;
...
{
	if ( 
		 !( FStrEq( STRING( pev->classname ), "grenade" ) || FStrEq( STRING( pev->classname ), "monster_satchel" ) ) ||
		 strcmp( STRING( pevInflictor->classname ), "player" ) == 0 ||

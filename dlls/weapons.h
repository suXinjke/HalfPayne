...
extern void RadiusDamage( Vector vecSrc, entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, float flRadius, int iClassIgnore, int bitsDamageType, bool explicitExplosion = true );
...
class CIngram : public CBasePlayerWeapon
{
public:
	void Spawn( void );
	void Precache( void );
...
private:
	...
	unsigned short m_usFireIngram;
};

class CIngramTwin : public CBasePlayerWeapon
{
public:
	void Spawn( void );
	void Precache( void );
...
private:
	...
	unsigned short m_usFireIngram;
	unsigned short m_usFireIngramTracer;
};

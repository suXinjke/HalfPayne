...
inline int SPR_Height( SPRITE_HANDLE x, int f )	{ return gEngfuncs.pfnSPR_Height(x, f); }
inline int SPR_Width( SPRITE_HANDLE x, int f )	{ return gEngfuncs.pfnSPR_Width(x, f); }
